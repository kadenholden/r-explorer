...
export const VIEWS: Record<string, CameraView> = {
  ...
  engine: { label: 'Engine', position: [0.7, 0.42, 0.95], target: [0, 0.12, 0], kind: 'bookmark' },
  'engine-top': { label: 'Engine top', position: [0.02, 1.45, 0.06], target: [0, 0.1, 0], kind: 'bookmark' },
  intake: { label: 'Intake', position: [0.55, 0.5, 1.3], target: [0, 0.1, 0.22], kind: 'bookmark' },
  'chain-end': { label: 'Chain end', position: [-0.6, 0.9, 0.55], target: [-0.28, 0.14, 0], kind: 'bookmark' },
  sump: { label: 'Sump', position: [0.72, -0.62, 0.62], target: [0, -0.22, 0], kind: 'bookmark' },
  transmission: { label: 'Gearbox', position: [-0.9, -0.12, 1.05], target: [-0.45, -0.05, 0], kind: 'bookmark' },
  driveline: { label: 'Driveline', position: [1.35, 0.05, -0.55], target: [-0.05, -0.28, -1.5], kind: 'bookmark' },
  'exhaust-line': { label: 'Exhaust', position: [1.3, 0.2, -2.9], target: [0, -0.3, -1.8], kind: 'bookmark' },
  ...
  'rear-axle': { label: 'Rear axle', position: [2.3, 0.45, -4.1], target: [0.2, -0.15, -2.55], kind: 'bookmark' },
