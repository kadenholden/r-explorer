    ...
    steps: [
      {
        ...
        text:
          'The blue-capped filler neck at the front-right of the bay is the only visible piece — the bottle itself hides behind the right-front wheel-arch liner. That’s why the leak “can’t be found” from above.',
        bonnet: true,
        shell: true,
        isolate: [],
      },
      {
        ...
        text:
          'Fill the bottle to the brim and immediately look under the right-front corner with a torch. Drips within a minute = grommet/pump area or a split neck joint. No drips until you use the washers = a hose joint further along instead.',
      ...
      },
      {
        ...
        text:
          'Steering on FULL LEFT lock for working room. Remove the arch-liner screws along the liner’s front half and peel it back — the bottle and pump are right there, ahead of the wheel. (No need to remove the wheel or the whole liner.)',
