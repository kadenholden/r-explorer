...
export const CAMERA_PRESETS: Record<string, CameraPreset> = {
  'front-three-quarter': { label: 'Overview', position: [2.6, 1.15, 2.5], target: [0, 0.1, -0.5] },
  ...
  'rear-axle': { label: 'Rear axle', position: [2.2, 0.4, -2.9], target: [0.2, -0.15, -1.42] },
  'exhaust-line': { label: 'Exhaust', position: [1.1, 0.2, -1.9], target: [0, -0.3, -1.1] },
